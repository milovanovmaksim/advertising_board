...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('itn', models.CharField(blank=True, max_length=100, verbose_name='ИНН')),
                ('img', models.ImageField(default='profile/default_user_logo.png', upload_to='profile/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=4, verbose_name='Код из СМС')),
